...
const CREDITS = [
    {
        ...
        rows: [['Emmanuel Nwaeke', 'All']],
    },
    {
        title: 'Modeling & Texturing',
        rows: [
            ['Emmanuel Nwaeke', 'Texturing, Composition, & UV'],
    ...
    },
    {
        title: 'Sound Design',
        rows: [
            ['Emmanuel Nwaeke', 'Mixing, Composition, & Foley'],
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={'© Copyright 2022 Emmanuel Nwaeke'}
        >
            <div
