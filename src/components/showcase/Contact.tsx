        ...
        <div className="site-page-content">
            <div style={styles.header}>
                ...
                <div style={styles.socials}>
                    <SocialBox
                        icon={ghIcon}
                        link={'https://github.com/userIssa'}
                    />
                    <SocialBox
                        icon={inIcon}
                        link={'https://www.linkedin.com/in/emmanuel-nwaeke-43014527b/'}
                    />
                    <SocialBox
                        icon={twitterIcon}
                        link={'https://twitter.com/theykn0wissa'}
                    />
                </div>
            </div>
            <div className="text-block">
                <p>
                    I am currently employed, but if you have any
